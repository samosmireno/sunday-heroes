...
- **Only Match is season-scoped.** `TeamCompetition` (standings) and `TeamRoster` stay competition-scoped; standings are current-season only by design, and rosters carry across seasons.
