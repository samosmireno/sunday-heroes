...
- **Change record.** Managers and admins: every act on the match with actor, old and new values. A migrated match's first entry reads "Imported · recorded by Ana" (`15-migration.md`).
