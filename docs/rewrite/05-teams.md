...
- **Data migration (15)**: nothing. Production holds no team format competition; the Home and Away rows collapse into Pickup sides as the map says, and no Team, Entry or roster is created. Settled in `15-migration.md`: as stated; the 44 Team rows, including 26 test leftovers, migrate nowhere.
