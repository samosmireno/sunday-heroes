...
export default function PastSeasonBanner({
  ...
  return (
    <div
      role="status"
      className="relative mb-6 flex flex-col gap-2 rounded-lg border-2 border-accent/40 bg-panel-bg px-4 py-3 shadow-md sm:flex-row sm:items-center sm:justify-between"
    >
