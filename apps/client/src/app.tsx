...
// PROTOTYPE — throwaway (issue #37); drop with the branch.
import PrototypeIneligibleVoterPage from "./pages/prototype-ineligible-voter-page";
...
const publicRoutes = [
  ...
  // PROTOTYPE — throwaway (issue #37); drop with the branch.
  {
    path: "/prototype/ineligible-voter",
    element: <PrototypeIneligibleVoterPage />,
  },
];
